...
def image_path():
    ...
    if skin_dir not in {"skin.fentastic", "skin.fentastic.oneadvent"}:
        skin_dir = "skin.fentastic.oneadvent"
    return f"special://home/addons/{skin_dir}/resources/rating_images/"
