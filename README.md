# Fentastic Oneadvent Skin

Custom Kodi skin build based on **FENtastic**.
...
3. Install `repository.oneadvent-1.0.1.zip`
...
`https://1advent.github.io/kodiskin/zips/repository.oneadvent/repository.oneadvent-1.0.1.zip`
...
Credit to Ivar Brandt for the original skin design, structure, and upstream work this customization builds on.
...
Please keep upstream attribution intact when redistributing or modifying this project.
